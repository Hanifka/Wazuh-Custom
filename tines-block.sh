#!/usr/bin/env bash
# Tines → Wazuh Active Response: Block/Unblock IOC (IPv4)
# - Hanif K
...
# Read the single JSON line from stdin, but don't hang forever.
# -t 2 : give execd time to close stdin; adjust if needed.
AR_PAYLOAD=""
